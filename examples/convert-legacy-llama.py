...
class OutputFile:
    ...
    def add_meta_model(self, params: Params, metadata: gguf.Metadata) -> None:
    ...
    def write_vocab_only(
        ...
        endianess: gguf.GGUFEndian = gguf.GGUFEndian.LITTLE, pad_vocab: bool = False, metadata: gguf.Metadata = None,
    ) -> None:
